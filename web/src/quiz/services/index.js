...
export function deleteUserQuiz(token, userId, quizId, onSuccess, onError) {
    return apiFetch(
        `/api/quiz/users/${userId}/quizzes/${quizId}`,
        "DELETE",
        token,
        undefined,
        onSuccess,
...
export function createOrUpdateUserQuizQuestion(token, userId, quizId, questionId, question, onSuccess, onError) {
    return apiFetch(
        questionId ? `/api/quiz/users/${userId}/quizzes/${quizId}/questions/${questionId}` : `/api/quiz/users/${userId}/quizzes/${quizId}/questions`,
...
export function getUserQuizQuestions(token, userId, quizId, onSuccess, onError) {
    return apiFetch(
        `/api/quiz/users/${userId}/quizzes/${quizId}/questions`,
        "GET",
        token,
        undefined,
        onSuccess,
...
export function deleteUserQuizQuestion(token, userId, quizId, questionId, onSuccess, onError) {
    return apiFetch(
        `/api/quiz/users/${userId}/quizzes/${quizId}/questions/${questionId}`,
        "DELETE",
        token,
        undefined,
        onSuccess,
